...
class Sc_perox(GSMM):
    ...
    def build_model(self):
        ...
        Acetyl_CoA = self.model.metabolites.get_by_id("s_0378")
        Acetoacetyl_CoA = self.model.metabolites.get_by_id("s_2914")
        CoA = self.model.metabolites.get_by_id("s_0534")
        HMG_CoA = Metabolite(id="s_4271", formula="C27H39N7O20P3S", name="3-hydroxy-3-methylglutaryl-CoA[p]", charge=-5, compartment="p")
        NADPH = self.model.metabolites.get_by_id("s_1215")
        NADP = self.model.metabolites.get_by_id("s_1211")
        Hydrogen = self.model.metabolites.get_by_id("s_0801")
        ...
        ATP = self.model.metabolites.get_by_id("s_0439")
        ADP = self.model.metabolites.get_by_id("s_0399")
        ...
        NPP = Metabolite(id="s_4281",formula='C10H17O7P2', name='neryl diphosphate[p]', charge=-3, compartment='p')
        CO2 = self.model.metabolites.get_by_id("s_0462")
        Diphosphate = self.model.metabolites.get_by_id("s_0638")

        # initialize reaction obchange_info_offsetects for heterologous reactions
        Erg10_reaction = Reaction(id="MVA1", name="2.0 Acetyl-CoA --> 1.0 Acetoacetyl-CoA + 1.0 CoA", upper_bound=1000.0, lower_bound=0, subsystem="p")
        ...
        Phosphate_con_reaction = Reaction(id="r_phosphate_con", name="1.0 Phosphate ->", upper_bound=1000.0, lower_bound=0) #artificial phosphate consumption, to avoid accumulation
        ...
        Phosphate_con_reaction.add_metabolites({
            Phosphate: -1.0
        })
        ...
        reactionlist = [Erg10_reaction,Erg13_reaction,tHMGR_reaction,Erg12_reaction,Erg8_reaction,Erg19_reaction,Idi1_reaction,
            mFPS144_GPP_reaction,mFPS144_FPP_reaction,AgGPPS2_reaction,SiNPPS1_reaction,APS_gpp_reaction,APS_npp_reaction,APinene_con_reaction,Phosphate_con_reaction]
        # Add reactions to model
        self.model.add_reactions(reactionlist)
